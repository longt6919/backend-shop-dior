...
public class MessageKeys {
    ...
    public static final String UPLOAD_IMAGES_FORMAT = "product.update_image.format";
    public static final String CREATE_PRODUCT_SUCCESSFULLY = "product.create_product.create_successfully";
    public static final String UPLOAD_FILES = "product.upload_images.upload";
    public static final String DELETE_PRODUCT_BY_ID = "product.delete_product.delete_successfully";
    public static final String DELETE_PRODUCT_FALSE = "product.delete_product.delete_false";
    public static final String UPLOAD_PRODUCT_SUCCESSFULLY = "product.upload_product.upload_successfully";
    public static final String UPLOAD_PRODUCT_FALSE = "product.upload_product.upload_false";
